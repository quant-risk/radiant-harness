...
| 52 | v2.0.0 | Output Streaming — executor em tempo real via `--stream` + bugfix `discover→discover` | 2 | `internal/loop/`, `cmd/` | 8 | ✅ |

**Total entregue (Sprints 1–52)**: 19 packages, 133 testes no loop package, suite completa green  
**Versão atual**: v2.0.0
