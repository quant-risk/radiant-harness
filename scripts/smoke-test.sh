...
# 2. Version contains 3.3.x or 3.4.x (any 3.3/3.4 release).
V="$("$BIN" --version 2>&1 || true)"
case "$V" in
  *"3.3.0"*|*"3.3.1"*|*"3.3.2"*|*"3.4.0"*) ok "version reports '$V'" ;;
  *)                           fail "expected version to contain '3.3.x' or '3.4.0', got: $V" ;;
esac
